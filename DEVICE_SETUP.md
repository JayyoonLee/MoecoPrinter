...
![홈화면 확장](images/home_screen_expand.jpg)
...
![설정화면](images/settings_screen.jpg)
...
![설정-시스템](images/settings_system.jpg)
...
![설정-시스템-네트워크](images/settings_network.jpg)
...
![네트워크 IP 확인](images/network_ip_confirm.jpg)
...
![bridge.py 실행](images/bridge_run.png)
...
![새로만들기 다이나믹텍스트](images/new_dynamic_text.jpg)
...
![다이나믹텍스트 추가](images/dynamic_text_add.jpg)
...
![다이나믹텍스트 이동](images/dynamic_text_move.jpg)
...
![다이나믹텍스트 설정](images/dynamic_text_settings.jpg)
...
![다이나믹텍스트 문구 수정](images/dynamic_text_edit.jpg)
...
![웹 UI Send](images/web_ui_send.png)
...
![출력 결과 1](images/print_result_1.jpg)

첫 번째 출력 결과입니다. (`Test다이나믹텍스트`)

![출력 결과 2](images/print_result_2.jpg)
